                ...
                <div className="mt-6 pt-4 border-t border-slate-100">
                  {requestingUser === user._id ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 rounded-md bg-slate-900 py-2 text-xs font-medium text-white hover:bg-slate-700 disabled:bg-slate-400"
                        >
                          {sendRequestMutation.isPending ? "Sending..." : "Confirm Request"}
                        </button>
                        <button
                          onClick={() => setRequestingUser(null)}
                          className="rounded-md border border-slate-300 px-4 py-2 text-xs font-medium text-slate-700 hover:bg-slate-100"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    <button
                      ...
                      className="w-full rounded-md border border-slate-900 py-2 text-xs font-medium text-slate-900 transition hover:bg-slate-900 hover:text-white"
                    >
                      Send Swap Request
                    </button>
                  )}
